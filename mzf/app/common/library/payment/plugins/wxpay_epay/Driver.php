...
namespace app\common\library\payment\plugins\wxpay_epay;
...
/**
 * 易支付-微信 驱动（wxpay_epay）
 *
 * 移植自旧 protected/payplug/wxpay_epay/config.php（v1.0.0）。
 ...
 *
 * @see /www/wwwroot/peakpay/protected/payplug/wxpay_epay/config.php 原始实现
 */
class Driver extends AbstractPaymentChannel
{
    protected string $cType = 'wxpay_epay';

    /** 易支付上游支付方式类型 */
    protected string $payType = 'wxpay';
