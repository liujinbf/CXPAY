...
namespace app\common\library\payment\plugins\qqpay_epay;
...
/**
 * 易支付-QQ钱包 驱动（qqpay_epay）
 *
 * 移植自旧 protected/payplug/qqpay_epay/config.php（v1.0.0）。
 ...
 *
 * @see /www/wwwroot/peakpay/protected/payplug/qqpay_epay/config.php 原始实现
 */
class Driver extends AbstractPaymentChannel
{
    protected string $cType = 'qqpay_epay';

    /** 易支付上游支付方式类型 */
    protected string $payType = 'qqpay';
