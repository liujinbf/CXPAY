...
namespace CXPayMonitor
{
    public sealed class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            captureMode.Items.AddRange(new object[] { "微信收款单/小账本窗口", "授权账单源" });
            BuildLayout();
            LoadConfig();
        ...
        private void LoadConfig()
        {
            ...
            captureMode.SelectedIndex = config.CaptureMode == AppConfig.AuthorizedFeedMode ? 1 : 0;
        ...
        private AppConfig ReadConfig()
        {
            ...
            return new AppConfig
            {
                ...
                CaptureMode = captureMode.SelectedIndex == 1 ? AppConfig.AuthorizedFeedMode : AppConfig.WechatUiMode,
        ...
        {
            bool wechatMode = captureMode.SelectedIndex != 1;
            windowList.Enabled = wechatMode && engine == null;
            refreshWindowsButton.Enabled = wechatMode && engine == null;
            inspectWindowButton.Enabled = wechatMode && engine == null;
            feedUrl.Enabled = !wechatMode && engine == null;
            feedToken.Enabled = !wechatMode && engine == null;
            if (wechatMode) payType.SelectedItem = "wxpay";
            payType.Enabled = !wechatMode && engine == null;
        }
